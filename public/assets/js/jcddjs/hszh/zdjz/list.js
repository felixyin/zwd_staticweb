...
$(function () {
    ...
    layui.use(['table', 'form', 'laypage', 'layer', 'element', 'laydate', 'upload'], function () {
        ...
        table.render({
            ...
            method: 'get',
            loading: true,
            url: 'http://127.0.0.1:8000/assets/js/api/data/jcddjs/hszh/zdjz/list.json'+'?t='+(new Date().getTime()),//数据接口
            headers: setHeader(),
            ...
            cols: [[    //表头
                ...
                {field: 'c1', title: '救助人', align: 'left', width: 150},

                {field: 'c2', title: '性别', align: 'left', width: 150},

                {field: 'c3', title: '民族', align: 'left', width: 150},

                {field: 'c4', title: '出生年月', align: 'left', width: 150},

                {field: 'c5', title: '政治面貌', align: 'left', width: 150},

                {field: 'c6', title: '参加工作中时间', align: 'left', width: 150},

                {field: 'c7', title: '单位', align: 'left', width: 150},

                {field: 'c8', title: '家庭住址', align: 'left', width: 150},

                {field: 'c9', title: '联系电话', align: 'left', width: 150},

                {field: 'c10', title: '病情及经济状况', align: 'left', width: 150},

                {field: 'c11', title: '学校意见', align: 'left', width: 150},

                {field: 'c12', title: '资助中心审核意见', align: 'left', width: 150},

                {field: 'c13', title: '重大救助', align: 'left', width: 150},
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'del') {  //删除
                layer.confirm('真的要删除这行数据？', function (index) {
                    ...
                    $.ajax({
                        url: 'http://127.0.0.1:8000/assets/js/api/data/jcddjs/hszh/zdjz/remove.json'+'?t='+(new Date().getTime()),//数据接口
                        type: "POST",              //请求类型
        ...
        form.on('submit(addInfo)', function (data) {
            ...
            $.ajax({
                url:'http://127.0.0.1:8000/assets/js/api/data/jcddjs/hszh/zdjz/add.json'+'?t='+(new Date().getTime()),//数据接口
                type: "POST",              //请求类型
                data: formatParam(requestData),              //请求数据
                timeout: 200000,                //请求超时时间(毫秒)
                headers: setHeader(),
        ...
        form.on('submit(editInfo)', function (data) {
            ...
            var requestData = formToJsonObj("form_edit", []);
            $.ajax({
                url:'http://127.0.0.1:8000/assets/js/api/data/jcddjs/hszh/zdjz/edit.json'+'?t='+(new Date().getTime()),//数据接口
                type: "POST",              //请求类型
                data: formatParam(requestData),              //请求数据
                timeout: 200000,                //请求超时时间(毫秒)
                headers: setHeader(),
