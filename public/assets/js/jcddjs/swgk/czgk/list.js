...
$(function () {
    ...
    layui.use(['table', 'form', 'laypage', 'layer', 'element', 'laydate', 'upload'], function () {
        ...
        table.render({
            ...
            method: 'get',
            loading: true,
            url: 'http://127.0.0.1:8000/assets/js/api/data/jcddjs/swgk/czgk/list.json'+'?t='+(new Date().getTime()),//数据接口
            headers: setHeader(),
            ...
            cols: [[    //表头
                ...
                try{
                    ...
                    tableRowSpanNoFixedCol('tabledata', "c1", "left");
                    
                    tableRowSpanNoFixedCol('tabledata', "c2", "left");
                    
                    tableRowSpanNoFixedCol('tabledata', "c3", "left");
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'del') {  //删除
                layer.confirm('真的要删除这行数据？', function (index) {
                    ...
                    $.ajax({
                        url: "/fpmsResidentialQuarters/delete.do",               //请求地址
                        type: "POST",              //请求类型
        ...
        form.on('submit(editInfo)', function (data) {
            ...
            $.ajax({
                url: "/fpmsResidentialQuarters/update.do",               //请求地址
                type: "POST",              //请求类型
                data: formatParam(requestData),              //请求数据
                timeout: 200000,                //请求超时时间(毫秒)
                headers: setHeader(),
