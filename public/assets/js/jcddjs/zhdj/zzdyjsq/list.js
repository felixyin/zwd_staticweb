...
$(function () {
    ...
    layui.use(['table', 'form', 'laypage', 'layer', 'element', 'laydate', 'upload'], function () {
        ...
        table.render({
            ...
            method: 'get',
            loading: true,
            url: 'http://127.0.0.1:8000/assets/js/api/data/jcddjs/zhdj/zzdyjsq/list.json'+'?t='+(new Date().getTime()),//数据接口
            headers: setHeader(),
            ...
            cols: [[    //表头
                ...
                {field: 'c1', title: '姓名', align: 'left', width: 150},

                {field: 'c2', title: '性别', align: 'left', width: 150},

                {field: 'c3', title: '出生年月', align: 'left', width: 150},

                {field: 'c4', title: '政治面貌', align: 'left', width: 150},

                {field: 'c5', title: '报道服务社区', align: 'left', width: 150},

                {field: 'c6', title: '家庭住址', align: 'left', width: 150},

                {field: 'c7', title: '工作单位', align: 'left', width: 150},

                {field: 'c8', title: '工作职务', align: 'left', width: 150},

                {field: 'c9', title: '联系电话', align: 'left', width: 150},

                {field: 'c10', title: '党员申请岗位', align: 'left', width: 150},

                {field: 'c11', title: '党员承诺', align: 'left', width: 150},

                {field: 'c12', title: '社区党组织意见', align: 'left', width: 150},

                {field: 'c13', title: '机关党组织意见', align: 'left', width: 150},
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'del') {  //删除
                layer.confirm('真的要删除这行数据？', function (index) {
                    ...
                    $.ajax({
                        url: 'http://127.0.0.1:8000/assets/js/api/data/jcddjs/zhdj/zzdyjsq/remove.json'+'?t='+(new Date().getTime()),//数据接口
                        type: "POST",              //请求类型
        ...
        form.on('submit(addInfo)', function (data) {
            ...
            $.ajax({
                url:'http://127.0.0.1:8000/assets/js/api/data/jcddjs/zhdj/zzdyjsq/add.json'+'?t='+(new Date().getTime()),//数据接口
                type: "POST",              //请求类型
                data: formatParam(requestData),              //请求数据
                timeout: 200000,                //请求超时时间(毫秒)
                headers: setHeader(),
        ...
        form.on('submit(editInfo)', function (data) {
            ...
            var requestData = formToJsonObj("form_edit", []);
            $.ajax({
                url:'http://127.0.0.1:8000/assets/js/api/data/jcddjs/zhdj/zzdyjsq/edit.json'+'?t='+(new Date().getTime()),//数据接口
                type: "POST",              //请求类型
                data: formatParam(requestData),              //请求数据
                timeout: 200000,                //请求超时时间(毫秒)
                headers: setHeader(),
